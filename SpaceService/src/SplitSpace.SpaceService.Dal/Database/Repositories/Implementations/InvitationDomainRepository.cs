...
public class InvitationDomainRepository : IInvitationDomainRepository
{
    ...
    public InvitationDomainRepository(IDbConnectionFactory connectionFactory)
        : this(connectionFactory, null)
    {
    }

    internal InvitationDomainRepository(IDbConnectionFactory connectionFactory, NpgsqlTransaction? transaction)
    {
